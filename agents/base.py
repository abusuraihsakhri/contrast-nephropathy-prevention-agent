...
class AuditLogger:
    ...
    @staticmethod
    def initialize(secret_key: Optional[str] = None) -> None:
        """Explicitly initialize the global audit trail with a secret key."""
        global _GLOBAL_AUDIT
        _GLOBAL_AUDIT = AuditTrail(secret_key=secret_key)
